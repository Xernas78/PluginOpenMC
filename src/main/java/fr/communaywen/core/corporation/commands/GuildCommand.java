...
import fr.communaywen.core.corporation.GuildOwner;
import fr.communaywen.core.corporation.PlayerShopManager;
import fr.communaywen.core.corporation.menu.GuildBaltopMenu;
import fr.communaywen.core.corporation.menu.GuildMenu;
import fr.communaywen.core.corporation.menu.GuildSearchMenu;
...
public class GuildCommand {
    ...
    @Subcommand("usage")
    @Description("Afficher l'utilisation des commandes de guilde")
